...
public class CommandTestUtil {
    ...
    public static final String REMARK_DESC_BOB = " " + PREFIX_REMARK + VALID_REMARK_AMY;
    ...
    public static final String INVALID_REMARK_DESC = " " + PREFIX_REMARK + "likes&"; // '&' not allowed in remarks
