...
import static seedu.address.logic.parser.ParserUtil.MESSAGE_INVALID_TYPE;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Contact expectedContact = ContactBuilder.fromContact(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Contact expectedContactMultipleTags = ContactBuilder.fromContact(BOB)
                .withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND).build();
        assertParseSuccess(parser,
                TYPE_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
    ...
    public void parse_repeatedNonTagValue_failure() {
        String validExpectedContactString = TYPE_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_FRIEND;

        // multiple types
        assertParseFailure(parser, TYPE_DESC_AMY + validExpectedContactString,
        ...
        assertParseFailure(parser,
                validExpectedContactString
                        + TYPE_DESC_AMY + PHONE_DESC_AMY + EMAIL_DESC_AMY + NAME_DESC_AMY + ADDRESS_DESC_AMY
                        + validExpectedContactString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_TYPE,
        ...
        // invalid type
        assertParseFailure(parser, INVALID_TYPE_DESC + validExpectedContactString,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_TYPE));
        ...
        // invalid type
        assertParseFailure(parser, validExpectedContactString + INVALID_TYPE_DESC,
                Messages.getErrorMessageForDuplicatePrefixes(PREFIX_TYPE));
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Contact expectedContact = ContactBuilder.fromContact(AMY).withTags().build();
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing type prefix
        assertParseFailure(parser, VALID_TYPE_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing name prefix
        assertParseFailure(parser, TYPE_DESC_BOB + VALID_NAME_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, TYPE_DESC_BOB + NAME_DESC_BOB + VALID_PHONE_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, TYPE_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + VALID_EMAIL_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, TYPE_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + VALID_ADDRESS_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_TYPE_BOB + VALID_NAME_BOB + VALID_PHONE_BOB
    ...
    public void parse_invalidValue_failure() {
        // invalid type
        assertParseFailure(parser, INVALID_TYPE_DESC + NAME_DESC_BOB + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                MESSAGE_INVALID_TYPE);

        // invalid name
        assertParseFailure(parser, TYPE_DESC_BOB + INVALID_NAME_DESC + PHONE_DESC_BOB
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
                Name.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, TYPE_DESC_BOB + NAME_DESC_BOB + INVALID_PHONE_DESC
                + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
        ...
        // invalid tag
        assertParseFailure(parser, TYPE_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + TYPE_DESC_BOB + NAME_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
